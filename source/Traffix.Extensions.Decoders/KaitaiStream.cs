...
{
    /// <summary>
    /// Implements KaitaiStream for pipes.
    /// </summary>
    public class KaitaiPipeStream : KaitaiStream
    {
        public KaitaiPipeStream(PipeReader pipeReader) : base(pipeReader.AsStream(true)) { }
    }
    /// <summary>
    ...
    public partial class KaitaiStream : BinaryReader
    {
        ...
        public KaitaiStream(ArraySegment<byte> bytes) : base(new MemoryStream(bytes.Array, bytes.Offset, bytes.Count))
        {
